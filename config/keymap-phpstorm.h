...
/*_*/#define P_INTENT  LC(LA(I))            // intent
/*_*/#define P_REFORM  LC(LA(L))            // reformat
/*_*/#define P_CAR_UP  LC(LA(PG_UP))        // clone caret above
/*_*/#define P_CAR_DN  LC(LA(PG_DN))        // clone caret above
